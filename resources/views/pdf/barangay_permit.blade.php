...
<head>
    ...
    <title>Barangay Permit – Letter</title>
    <style>
        /* Page setup */
    ...
    <div class="letter">
        ...
        <div class="header-content">
            <div class="header-left">
                ...
                <span class="company-tagline">Business Permit Confirmation</span>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="to-name">{{ $permit['full_name'] ?? '—' }}</div>
            ...
            <div class="date-value">{{ $permit['application_date'] ?? now()->format('m/d/Y') }}</div>

            <div class="greeting">Dear Sir/Madam,</div>
            <p class="paragraph">
                This letter confirms the approval of your Barangay Business Permit application.
                Please keep a printed copy of this permit for your records and present it upon request
                at your barangay office. Details are provided below.
            </p>

            <table class="details">
                <tr>
                    <td class="label">Permit ID</td>
                    <td class="value">#{{ $permit['id'] ?? '—' }}</td>
