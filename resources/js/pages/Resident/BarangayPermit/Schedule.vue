...
const props = defineProps<{ permit: { id: number; status: string; application_date?: string | null; appointment_at?: string | null } }>()
              ...
              <div>
                ...
                <Select v-model="form.time">
                  ...
                  <SelectContent position="popper" side="bottom" :sideOffset="4" align="start" :alignOffset="0" :avoidCollisions="true">
                    <SelectItem v-for="t in timeSlots" :key="t" :value="t">{{ formatTime24To12(t) }}</SelectItem>
                  </SelectContent>
                </Select>
