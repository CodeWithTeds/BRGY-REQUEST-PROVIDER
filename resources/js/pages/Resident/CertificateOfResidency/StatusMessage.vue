...
const props = defineProps<{ residency: { id?: number; status: string; remarks?: string; application_date?: string; appointment_at?: string | null; appointment_status?: string | null }, rescheduleAllowed?: boolean }>()
...
const appointmentStatusLabel = computed(() => {
  const s = props.residency.appointment_status as string | undefined | null
  if (!s) return null
