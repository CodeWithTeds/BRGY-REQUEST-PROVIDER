...
const props = defineProps<{ clearance: { id?: number; status: string; remarks?: string; application_date?: string; issue_date?: string | null; expiry_date?: string | null; clearance_number?: string | null; appointment_at?: string | null }, rescheduleAllowed?: boolean }>()
