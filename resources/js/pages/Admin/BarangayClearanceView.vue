                  ...
                  <div class="rounded-lg border border-[#2c4454]/20 p-4">
                    ...
                    <div class="mt-3">
                      ...
                      <template v-else-if="props.clearance.status === 'pre-approved'">
                        <div v-if="props.canApprove ?? true" class="grid grid-cols-2 gap-2">
                        ...
                        <div v-else-if="props.routeGroup === 'staff'" class="space-y-2">
                          <p class="text-sm text-[#2c4454]">This clearance is pre-approved by staff, awaiting admin approval.</p>
